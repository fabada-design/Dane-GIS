...
- **Earth Esa**
 ...
 - **LabGIS**   
      - _url:_ http://labgis.pl/?zrodla-danych
     - _opis:_ Strona udostępniająca dane przestrzenne (w formacie takim jak: GeoTIFF, Shapefile), które można wykorzystywać i modyfikować w systemach GIS. Dane te dotyczą np. Generalnej Dyrekcji Ochrony Środowiska (pomniki przyrody, parki krajobrazowe) i Lasów państwowych. Fabian Adamtschik.
